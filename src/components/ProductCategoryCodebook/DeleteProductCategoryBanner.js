...
const DeleteProductCategoryBanner = ({ show, data, onClose }) => {
  ...
  const deleteProductCategoryBanner = async (data) => {
    await dispatch(deleteProductCategoryThunk(data))
      .unwrap()
      .then(() => {
        showNotification({
        ...
        <Paper withBorder shadow="xs" radius="xs" p="lg">
          ...
          <Group position="right" mt="xs">
            ...
            <Button
              ...
              variant="default"
              size="xs"
              onClick={() => deleteProductCategoryBanner(data)}
            >
...
export default DeleteProductCategoryBanner;
