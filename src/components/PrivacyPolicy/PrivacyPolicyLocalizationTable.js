...
import PrivacyPolicyLocalizationModal from "./PrivacyPolicyLocalizationModal";
...
const PrivacyPolicyLocalizationTable=()=>{
    ...
    const closeDeleteBanner = () => {
      ...
      const addNewPrivacyPolicyLocalization = () => {
        setModalData(tableData);
        setModalVisible(true);
      };
    
      const updatePrivacyPolicyLocalization = (data) => {
      ...
      const deletePrivacyPolicyLocalization = async () => {
        ...
        await dispatch(
          ...
          .then(() => {
            showNotification({
              message: t("privacyPolicyLocalizationTable.deleteSucessfull"),
              color: "green",
            });
          })
          .catch((e) => {
            showNotification({
              message: t("privacyPolicyLocalizationTable.deleteError"),
              color: "red",
            });
          });
          ...
          <td className={classes.buttonColumn}>
            <Group position="right" className={classes.buttonContainer}>
              <Button
                ...
                variant="subtle"
                onClick={() => updatePrivacyPolicyLocalization(row)}
              >
      ...
      return (
        <>
          <ScrollArea className={classes.scrollArea}>
            <div className={classes.searchAndButtonContainter}>
              ...
              <Button
                ...
                onClick={() => addNewPrivacyPolicyLocalization()}
              >
                <Plus size={18} />
              </Button>
            </div>
            ...
            >
              <thead>
                <tr>
                  ...
                  >
                    {t("generalTermsLocalizationTable.locale")}
                  </Th>
                  <Th
                  ...
                  >
                    {t("generalTermsLocalizationTable.content")}
                  </Th>
          ...
          />
          <DeleteBanner
            deleteMethod={deletePrivacyPolicyLocalization}
            centered={true}
...
export default PrivacyPolicyLocalizationTable