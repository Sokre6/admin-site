...
const PrivacyPolicyTable=()=>{
  ...
  const localizeTableData = (data) => {
    ...
    const Th = ({ children, reversed, sorted, onSort }) => {
      ...
      useEffect(() => {
        dispatch(fetchLegalDocumentsByTypeThunk(PRIVACY_POLICY));
      }, []);
