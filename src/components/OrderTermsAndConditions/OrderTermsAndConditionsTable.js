...
import OrderTermsAndConditionsModal from "./OrderTermsAndConditionsModal";
...
const OrderTermsAndConditionsTable=()=>{

    const { t } = useTranslation();
    const dispatch = useDispatch();
    const { classes } = useStyles();
  
    const ORDER_TERMS_AND_CONDITIONS = "ORDER_TERMS_AND_CONDITIONS";
    ...
    useEffect(() => {
      dispatch(fetchLegalDocumentsByTypeThunk(ORDER_TERMS_AND_CONDITIONS));
    }, []);
          ...
          >
            <thead>
              <tr>
                ...
                >
                  {t("orderTermsAndConditionsTable.name")}
                </Th>
                <Th
                  sorted={sortBy === "type"}
                  reversed={reverseSortDirection}
                ...
                >
                  {t("orderTermsAndConditionsTable.type")}
                </Th>
                <Th
                ...
                >
                  {t("orderTermsAndConditionsTable.dateFrom")}
                </Th>
                <Th
                ...
                >
                  {t("orderTermsAndConditionsTable.dateTo")}
                </Th>
...
export default OrderTermsAndConditionsTable;