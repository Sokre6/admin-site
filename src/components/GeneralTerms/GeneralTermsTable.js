...
import GeneralTermsModal from "./GeneralTermsModal";
...
const GeneralTermsTable = () => {
  ...
  useEffect(() => {
    dispatch(fetchLegalDocumentsByTypeThunk(TERMS_AND_CONDITIONS));
  }, []);
...
export default GeneralTermsTable;
