...
import GeneralTermsLocalizationModal from "./GeneralTermsLocalizationModal";
...
const GeneralTermsLocalizationTable = (props) => {
  ...
  const addNewGeneralTermsLocalization = () => {
    setModalData(tableData);
    setModalVisible(true);
  };

  const updateGeneralTermsLocalization = (data) => {
      ...
      <td className={classes.buttonColumn}>
        <Group position="right" className={classes.buttonContainer}>
          <Button
            ...
            variant="subtle"
            onClick={() => updateGeneralTermsLocalization(row)}
          >
      ...
      <ScrollArea className={classes.scrollArea}>
        <div className={classes.searchAndButtonContainter}>
          ...
          <Button
            ...
            onClick={() => addNewGeneralTermsLocalization()}
          >
            <Plus size={18} />
          </Button>
        </div>
...
export default GeneralTermsLocalizationTable;
